...
type Service interface {
	...
	Get(listID, size, page int) (tasks []models.Task, extErr exterrors.ExtError)

	GetByID(taskID int) (task models.Task, extErr exterrors.ExtError)

	Create(listID int64, name, description string, position int16) (task models.Task, extErr exterrors.ExtError)
